...
def register(sub: argparse._SubParsersAction[argparse.ArgumentParser]) -> None:
    ...
    def add_common(game_parser: argparse.ArgumentParser, spec: BuildSpec) -> None:
        ...
        game_parser.add_argument("--audio", choices=spec.audio_choices, required=True)
